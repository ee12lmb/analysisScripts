...
function usage()
{
 echo "Usage: run_M_Disc.sh [ infile ] [ no. grains ] [ seed ] [ output name ]" 
...
matlab -nodesktop -nodisplay -nosplash -r "addpath('/nfs/see-fs-01_teaching/ee12lmb/project/source/dev/'); setup_env; m_indexDisc('$infile',$n,$seed,'outfile','$outfile'); exit;"
