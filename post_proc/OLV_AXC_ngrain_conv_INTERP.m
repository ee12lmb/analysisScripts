...
/nfs/see-fs-01_teaching/ee12lmb/project/analysis/scripts/batch_runs/olv_ax_converge/Jconv_OLV_AXC_n10000_run2.sh
/nfs/see-fs-01_teaching/ee12lmb/project/analysis/scripts/batch_runs/olv_ax_converge/MC_conv_OLV_AXC_n10000_run2.sh
/nfs/see-fs-01_teaching/ee12lmb/project/analysis/scripts/batch_runs/olv_ax_converge/MD_conv_OLV_AXC_n10000_INTERP.sh 
...
/nfs/see-fs-01_teaching/ee12lmb/project/analysis/outputs/IR/MD_conv_OLV_AXC_n10000_INTERP.out
...
addpath('/nfs/see-fs-01_teaching/ee12lmb/project/analysis/outputs/IR/MD_conv_OLV_AXC_n10000_INTERP.out')
...
for i = 1:length(steps)
    ...
    for j = 1:length(grains)
        ...
        fname = sprintf('OLV_AXC_md_n%d_r50_st%d_b1_sd1.out',grains(j),steps(i));
